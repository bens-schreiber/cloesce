...
use ast::{Api, Binding, CidlType, CloesceAst, DataSource, Field, Model, PlainOldObject, Service, Symbol, WranglerEnv};
use lexer::Token;
            ...
            for item in items {
                match item {
                    ...
                    Global::Service(service) => {
                        ast.services.insert(service.symbol.clone(), service);
                    }
