...
- [Models](./ch4-0-models.md)
  - [Worker Backed Models](./ch4-1-worker-models.md)
  - [SQLite Backed Models](./ch4-2-sqlite-backed-model.md)
  - [SQLite Column Constraints](./ch4-3-sqlite-constraints.md)
  - [KV Fields](./ch4-4-kv-fields.md)
  - [R2 Fields](./ch4-5-r2-fields.md)
  - [Navigation Fields](./ch4-6-navigation-fields.md)
