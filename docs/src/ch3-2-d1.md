...
Unlike [Workers KV and R2](./ch3-1-kv-and-r2.md), no templates can be defined on a D1 binding. However, any [Model](./ch4-1-sqlite-backed-model.md) defined in the schema can be bound to a D1 database, allowing the Model to represent a table in that database.
