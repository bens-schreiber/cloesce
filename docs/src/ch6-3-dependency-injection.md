...
A generated backend stub for the `stuff` API method will include an `env` parameter with **ORM upgraded** types, each reached by [its declared binding name](./ch7-0-orm-reference.md):
