...
Validator Tags can be applied to any field (i.e. follows the syntax `field: type`) in a [Model](./ch4-0-models.md), [API](./ch6-1-rest-apis.md) parameter, or [Data Source](./ch5-0-data-sources.md) parameter.

A [foreign key](./ch4-2-d1-constraints.md#foreign-key) field will automatically inherit all validators from the field it references. For example:
