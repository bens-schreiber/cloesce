...
/**
 * Generated surface for the `DB1Model` model.
 *
 * Implement via {@link impl}. Access data through data sources, not this namespace directly.
 *
 * @example
 * ```ts
 * export const DB1Model = clo.DB1Model.impl({
 *   async someApi(self, env, arg) {
 *     const row = await DB1Model.Default.get(env, arg);
...
export namespace DB1Model {
    ...
    export namespace GeneratedSource {
        ...
        export const Default = {
            ...
            /**
             * Load all matching `DB1Model` rows.
             *
            ...
            /**
             * Insert or update a `DB1Model` and its included relations.
             *
    ...
    /**
     * Register your implementation of `DB1Model`.
     *
     ...
     *     const res = await DB1Model.Default.get(env, arg);
     *     return res.data!;
     *   },
     * });
     * ```
     ...
     *
     * Prefer data sources (e.g. `DB1Model.Default.save(...)`) unless you need a custom tree or query.
     */
    export namespace Orm {
        /**
         * Insert or update `DB1Model` and its included relations.
         *
        ...
        /**
         * Hydrate an already-fetched `D1Result` into `DB1Model` rows.
         *
        ...
        /**
         * Hydrate a partial `DB1Model` into a full row, loading the included relations.
         *
...
/**
 * Generated surface for the `DB2Model` model.
 *
 * Implement via {@link impl}. Access data through data sources, not this namespace directly.
 *
 * @example
 * ```ts
 * export const DB2Model = clo.DB2Model.impl({
 *   async someApi(self, env, arg) {
 *     const row = await DB2Model.Default.get(env, arg);
 *     return this.otherApi(self, env);
 *   },
 * });
 * ```
...
export namespace DB2Model {
    ...
    export namespace GeneratedSource {
        ...
        export const Default = {
            ...
            /**
             * Load all matching `DB2Model` rows.
             *
             * @returns An {@link HttpResult} with the rows, or 400 on validation errors.
             */
            ...
            /**
             * Insert or update a `DB2Model` and its included relations.
             *
             * @returns An {@link HttpResult} with the saved row, 404 if target vanished, or 400 on validation errors.
             */
    ...
    /**
     * Register your implementation of `DB2Model`.
     *
     * Use `this` to call sibling methods and access generated data sources.
     *
     * @param implObj - Object implementing each {@link Api} method and any custom {@link Sources}.
     ...
     * export const DB2Model = clo.DB2Model.impl({
     *   async myApi(self, env, arg) {
     *     const res = await DB2Model.Default.get(env, arg);
     *     return res.data!;
     *   },
     * });
     * ```
     ...
     * Lower-level ORM access with explicit {@link IncludeTree}. Returns raw `CloesceResult`.
     *
     * Prefer data sources (e.g. `DB2Model.Default.save(...)`) unless you need a custom tree or query.
     */
    export namespace Orm {
        /**
         * Insert or update `DB2Model` and its included relations.
         *
         * @param env - Environment with the required database binding(s).
         * @param newModel - Partial row data to upsert.
         * @param include - Include tree controlling which relations to persist. Defaults to `Default.tree`.
        ...
        /**
         * Hydrate an already-fetched `D1Result` into `DB2Model` rows.
         *
         * @param result - The raw D1 query result to hydrate.
         * @param include - Include tree controlling nested object assembly. Defaults to `Default.tree`.
         * @returns The hydrated rows.
        ...
        /**
         * Hydrate a partial `DB2Model` into a full row, loading the included relations.
         *
         * @param env - Environment with the required binding(s).
         * @param base - Partial row with at least the primary/route key fields populated.
         * @param include - Include tree controlling which relations to load. Defaults to `Default.tree`.
