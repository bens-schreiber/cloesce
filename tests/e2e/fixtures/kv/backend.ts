...
export namespace ModelWithKv {
    ...
    export namespace GeneratedSource {
        export const Default = {
            ...
            selectQueryRaw: `SELECT "ModelWithKv"."id" AS "id", "ModelWithKv"."someColumn" AS "someColumn", "ModelWithKv"."someOtherColumn" AS "someOtherColumn" FROM "ModelWithKv"`,
            getQueryRaw: `SELECT "ModelWithKv"."id" AS "id", "ModelWithKv"."someColumn" AS "someColumn", "ModelWithKv"."someOtherColumn" AS "someOtherColumn" FROM "ModelWithKv" WHERE "ModelWithKv"."id" = ?1`,
            listQueryRaw: `SELECT "ModelWithKv"."id" AS "id", "ModelWithKv"."someColumn" AS "someColumn", "ModelWithKv"."someOtherColumn" AS "someOtherColumn" FROM "ModelWithKv" WHERE "ModelWithKv"."id" > ?1 ORDER BY "ModelWithKv"."id" ASC LIMIT ?2`,
