...
export class Global {
  static async setConfig(
    ...
    const __$baseUrl = new URL(
      `http://localhost:5843/api/Global/setConfig`
    );
    const __$payload: any = {};
    __$payload["value"] = value;
  ...
  static async getConfig(
    ...
    const __$baseUrl = new URL(
      `http://localhost:5843/api/Global/getConfig`
    );
...
export class Leaderboard {
  static async setScore(
    ...
    const __$baseUrl = new URL(
      `http://localhost:5843/api/Leaderboard/setScore`
    );
    const __$payload: any = {};
    __$payload["tenantId"] = tenantId;
    __$payload["score"] = score;
  ...
  static async getScore(
    ...
    const __$baseUrl = new URL(
      `http://localhost:5843/api/Leaderboard/getScore`
    );
  ...
  static fromJson(data: any): Leaderboard {
    const __$res = Object.assign(new Leaderboard(), data);
    return __$res;
  }
}
