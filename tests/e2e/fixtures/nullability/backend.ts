...
/**
 * Generated surface for the `NullabilityChecks` model.
 *
 * Implement via {@link impl}. Access data through data sources, not this namespace directly.
 *
 * @example
 * ```ts
 * export const NullabilityChecks = clo.NullabilityChecks.impl({
 *   async someApi(self, env, arg) {
 *     const row = await NullabilityChecks.Default.get(env, arg);
...
export namespace NullabilityChecks {
    ...
    export namespace GeneratedSource {
        ...
        export const Default = {
            ...
            /**
             * Load a single `NullabilityChecks`.
             *
            ...
            /**
             * Load all matching `NullabilityChecks` rows.
             *
            ...
            /**
             * Insert or update a `NullabilityChecks` and its included relations.
             *
    ...
    /**
     * Register your implementation of `NullabilityChecks`.
     *
     ...
     *     const res = await NullabilityChecks.Default.get(env, arg);
     *     return res.data!;
     *   },
     * });
     * ```
     ...
     *
     * Prefer data sources (e.g. `NullabilityChecks.Default.save(...)`) unless you need a custom tree or query.
     */
    export namespace Orm {
        /**
         * Insert or update `NullabilityChecks` and its included relations.
         *
        ...
        /**
         * Hydrate an already-fetched `D1Result` into `NullabilityChecks` rows.
         *
        ...
        /**
         * Hydrate a partial `NullabilityChecks` into a full row, loading the included relations.
         *
