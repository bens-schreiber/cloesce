    ...
    export namespace Source {
        export const Default = {
            ...
            async get(env: Env, id: number): Promise<NullabilityChecks.Self | null> {
                return await Orm.fromEnv(env).get<NullabilityChecks.Self>(NullabilityChecks.Meta, NullabilityChecks.Source.Default.getQuery(env, id), NullabilityChecks.Source.Default.include, {  });
            },
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<NullabilityChecks.Self[]> {
                return await Orm.fromEnv(env).list<NullabilityChecks.Self>(NullabilityChecks.Meta, NullabilityChecks.Source.Default.listQuery(env, lastSeen_id, limit), NullabilityChecks.Source.Default.include);
            },
        }
    }
