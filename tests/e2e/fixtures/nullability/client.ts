...
export class NullabilityChecks {
  ...
  async primitiveTypes(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/NullabilityChecks/${id}/primitiveTypes`
    );
    const payload: any = {};
    payload["a"] = a;
    payload["b"] = b;
  ...
  async modelTypes(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/NullabilityChecks/${id}/modelTypes`
    );
    const payload: any = {};
    payload["a"] = a;
  ...
  async injectableTypes(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/NullabilityChecks/${id}/injectableTypes`
    );
    const payload: any = {};
  ...
  async arrayTypes(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/NullabilityChecks/${id}/arrayTypes`
    );
    const payload: any = {};
    payload["a"] = a;
    payload["b"] = b;
  ...
  async httpResultTypes(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/NullabilityChecks/${id}/httpResultTypes`
    );
    const payload: any = {};
