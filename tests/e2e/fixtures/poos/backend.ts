    ...
    export namespace Source {
        export const Default = {
            ...
            async get(env: Env, id: number): Promise<PooAcceptYield.Self | null> {
                return await Orm.fromEnv(env).get<PooAcceptYield.Self>(PooAcceptYield.Meta, PooAcceptYield.Source.Default.getQuery(env, id), PooAcceptYield.Source.Default.include, {  });
            },
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<PooAcceptYield.Self[]> {
                return await Orm.fromEnv(env).list<PooAcceptYield.Self>(PooAcceptYield.Meta, PooAcceptYield.Source.Default.listQuery(env, lastSeen_id, limit), PooAcceptYield.Source.Default.include);
            },
        }
    }
