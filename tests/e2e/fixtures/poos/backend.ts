...
export namespace PooAcceptYield {
    ...
    export namespace GeneratedSource {
        export const Default = {
            tree: {},
            selectQueryRaw: `SELECT "PooAcceptYield"."id" AS "id" FROM "PooAcceptYield"`,
            getQueryRaw: `SELECT "PooAcceptYield"."id" AS "id" FROM "PooAcceptYield" WHERE "PooAcceptYield"."id" = ?1`,
            listQueryRaw: `SELECT "PooAcceptYield"."id" AS "id" FROM "PooAcceptYield" WHERE "PooAcceptYield"."id" > ?1 ORDER BY "PooAcceptYield"."id" ASC LIMIT ?2`,
