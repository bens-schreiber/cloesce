...
/**
 * Generated surface for the `Weather` model.
 *
 ...
 *     const row = await Weather.Default.get(env, arg);
...
export namespace Weather {
    ...
    export namespace GeneratedSource {
        ...
        export const Default = {
            ...
            /**
             * Load all matching `Weather` rows.
             *
            ...
            /**
             * Insert or update a `Weather` and its included relations.
             *
    ...
    /**
     * Register your implementation of `Weather`.
     *
     ...
     *     const res = await Weather.Default.get(env, arg);
     *     return res.data!;
     *   },
     * });
     * ```
     ...
     *
     * Prefer data sources (e.g. `Weather.Default.save(...)`) unless you need a custom tree or query.
     */
    export namespace Orm {
        /**
         * Insert or update `Weather` and its included relations.
         *
        ...
        /**
         * Hydrate an already-fetched `D1Result` into `Weather` rows.
         *
        ...
        /**
         * Hydrate a partial `Weather` into a full row, loading the included relations.
         *
