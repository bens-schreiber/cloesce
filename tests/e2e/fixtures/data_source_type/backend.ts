    ...
    export namespace Source {
        export const Baz = {
            ...
            async get(env: Env, id: number): Promise<Foo.Self | null> {
                return await Orm.fromEnv(env).get<Foo.Self>(Foo.Meta, Foo.Source.Baz.getQuery(env, id), Foo.Source.Baz.include, {  });
            },
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<Foo.Self[]> {
                return await Orm.fromEnv(env).list<Foo.Self>(Foo.Meta, Foo.Source.Baz.listQuery(env, lastSeen_id, limit), Foo.Source.Baz.include);
            },
        }
        export const Default = {
            ...
            getQuery: (env: Env, id: number) => env.db.prepare(`SELECT "Foo"."id" AS "id" FROM "Foo" WHERE "Foo"."id" = ?1`).bind(id),
            async get(env: Env, id: number): Promise<Foo.Self | null> {
                return await Orm.fromEnv(env).get<Foo.Self>(Foo.Meta, Foo.Source.Default.getQuery(env, id), Foo.Source.Default.include, {  });
            },
            listQuery: (env: Env, lastSeen_id: number, limit: number) => env.db.prepare(`SELECT "Foo"."id" AS "id" FROM "Foo" WHERE "Foo"."id" > ?1 ORDER BY "Foo"."id" ASC LIMIT ?2`).bind(lastSeen_id, limit),
            async list(env: Env, lastSeen_id: number, limit: number): Promise<Foo.Self[]> {
                return await Orm.fromEnv(env).list<Foo.Self>(Foo.Meta, Foo.Source.Default.listQuery(env, lastSeen_id, limit), Foo.Source.Default.include);
            },
        }
    }
    ...
    export namespace Source {
        export const Default = {
            ...
            async get(env: Env, id: number): Promise<NoDs.Self | null> {
                return await Orm.fromEnv(env).get<NoDs.Self>(NoDs.Meta, NoDs.Source.Default.getQuery(env, id), NoDs.Source.Default.include, {  });
            },
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<NoDs.Self[]> {
                return await Orm.fromEnv(env).list<NoDs.Self>(NoDs.Meta, NoDs.Source.Default.listQuery(env, lastSeen_id, limit), NoDs.Source.Default.include);
            },
        }
    }
    ...
    export namespace Source {
        export const Default = {
            ...
            async get(env: Env, id: number): Promise<OneDs.Self | null> {
                return await Orm.fromEnv(env).get<OneDs.Self>(OneDs.Meta, OneDs.Source.Default.getQuery(env, id), OneDs.Source.Default.include, {  });
            },
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<OneDs.Self[]> {
                return await Orm.fromEnv(env).list<OneDs.Self>(OneDs.Meta, OneDs.Source.Default.listQuery(env, lastSeen_id, limit), OneDs.Source.Default.include);
            },
        }
        export const ShitAss = {
            ...
            getQuery: (env: Env, id: number) => env.db.prepare(`SELECT "OneDs"."id" AS "id" FROM "OneDs" WHERE "OneDs"."id" = ?1`).bind(id),
            async get(env: Env, id: number): Promise<OneDs.Self | null> {
                return await Orm.fromEnv(env).get<OneDs.Self>(OneDs.Meta, OneDs.Source.ShitAss.getQuery(env, id), OneDs.Source.ShitAss.include, {  });
            },
            listQuery: (env: Env, lastSeen_id: number, limit: number) => env.db.prepare(`SELECT "OneDs"."id" AS "id" FROM "OneDs" WHERE "OneDs"."id" > ?1 ORDER BY "OneDs"."id" ASC LIMIT ?2`).bind(lastSeen_id, limit),
            async list(env: Env, lastSeen_id: number, limit: number): Promise<OneDs.Self[]> {
                return await Orm.fromEnv(env).list<OneDs.Self>(OneDs.Meta, OneDs.Source.ShitAss.listQuery(env, lastSeen_id, limit), OneDs.Source.ShitAss.include);
            },
        }
    }
