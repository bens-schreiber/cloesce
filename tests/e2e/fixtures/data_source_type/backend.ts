...
export namespace Foo {
    ...
    export namespace Source {
        export const Baz = {
            ...
            async get(env: Env, id: number): Promise<CloesceResult<Foo.Self | null>> {
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<CloesceResult<Foo.Self[]>> {
...
export namespace NoDs {
    ...
    export namespace Source {
        export const Default = {
            ...
            async get(env: Env, id: number): Promise<CloesceResult<NoDs.Self | null>> {
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<CloesceResult<NoDs.Self[]>> {
    ...
    export namespace Orm {
        ...
        export async function list(env: Env, args: { query?: D1PreparedStatement, include?: IncludeTree<Self> }): Promise<CloesceResult<NoDs.Self[]>> {
            args.include ??= Source.Default.include;
            return await CloesceOrm.fromEnv(env).list<Self>(Meta, args.query, args.include);
        }
...
export namespace OneDs {
    ...
    export namespace Source {
        export const Default = {
            ...
            async get(env: Env, id: number): Promise<CloesceResult<OneDs.Self | null>> {
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<CloesceResult<OneDs.Self[]>> {
    ...
    export namespace Orm {
        ...
        export async function list(env: Env, args: { query?: D1PreparedStatement, include?: IncludeTree<Self> }): Promise<CloesceResult<OneDs.Self[]>> {
            args.include ??= Source.Default.include;
            return await CloesceOrm.fromEnv(env).list<Self>(Meta, args.query, args.include);
        }
