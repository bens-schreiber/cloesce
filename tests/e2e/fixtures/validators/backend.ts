...
function storeHelpers(namespace: KVNamespace) {
    return {
        /** Typed helpers for `data` on `env.store`. */
        data: {
...
/**
 * Generated surface for the `Validator` model.
 *
 ...
 *     const row = await Validator.Default.get(env, arg);
...
export namespace Validator {
    ...
    export namespace GeneratedSource {
        ...
        export const Default = {
            ...
            /**
             * Load all matching `Validator` rows.
             *
            ...
            /**
             * Insert or update a `Validator` and its included relations.
             *
    ...
    /**
     * Register your implementation of `Validator`.
     *
     ...
     *     const res = await Validator.Default.get(env, arg);
     *     return res.data!;
     *   },
     * });
     * ```
     ...
     *
     * Prefer data sources (e.g. `Validator.Default.save(...)`) unless you need a custom tree or query.
     */
    export namespace Orm {
        /**
         * Insert or update `Validator` and its included relations.
         *
        ...
        /**
         * Hydrate an already-fetched `D1Result` into `Validator` rows.
         *
        ...
        /**
         * Hydrate a partial `Validator` into a full row, loading the included relations.
         *
