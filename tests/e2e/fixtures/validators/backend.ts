...
export namespace Validator {
    ...
    export namespace GeneratedSource {
        export const Default = {
            tree: {"someData":{}},
            selectQueryRaw: `SELECT "Validator"."id" AS "id", "Validator"."email" AS "email" FROM "Validator"`,
            getQueryRaw: `SELECT "Validator"."id" AS "id", "Validator"."email" AS "email" FROM "Validator" WHERE "Validator"."id" = ?1`,
            listQueryRaw: `SELECT "Validator"."id" AS "id", "Validator"."email" AS "email" FROM "Validator" WHERE "Validator"."id" > ?1 ORDER BY "Validator"."id" ASC LIMIT ?2`,
