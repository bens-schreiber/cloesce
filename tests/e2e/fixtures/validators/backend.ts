...
export namespace Validator {
    ...
    export namespace Source {
        export const Default = {
            ...
            async get(env: Env, id: number, name: string): Promise<Validator.Self | null> {
            ...
            async list(env: Env, lastSeen_id: number, limit: number): Promise<Validator.Self[]> {
    ...
    export namespace Orm {
        ...
        export async function get(env: Env, args: { query?: D1PreparedStatement, include?: IncludeTree<Self>, keyFields?: { name?: string } }): Promise<Self | null> {
        ...
        export async function hydrate(env: Env, base: DeepPartial<Self>, name: string, include: IncludeTree<Self> = Source.Default.include): Promise<Self> {
