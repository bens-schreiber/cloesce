...
export namespace Course {
    ...
    export namespace GeneratedSource {
        export const Default = {
            tree: {"studentCourses":{}},
            selectQueryRaw: `SELECT "Course"."id" AS "id", "Course"."title" AS "title", "StudentCourse_1"."studentId" AS "studentCourses.studentId", "StudentCourse_1"."studentName" AS "studentCourses.studentName", "StudentCourse_1"."courseId" AS "studentCourses.courseId" FROM "Course" LEFT JOIN "StudentCourse" AS "StudentCourse_1" ON "Course"."id" = "StudentCourse_1"."courseId"`,
            getQueryRaw: `SELECT "Course"."id" AS "id", "Course"."title" AS "title", "StudentCourse_1"."studentId" AS "studentCourses.studentId", "StudentCourse_1"."studentName" AS "studentCourses.studentName", "StudentCourse_1"."courseId" AS "studentCourses.courseId" FROM "Course" LEFT JOIN "StudentCourse" AS "StudentCourse_1" ON "Course"."id" = "StudentCourse_1"."courseId" WHERE "Course"."id" = ?1`,
            listQueryRaw: `SELECT "Course"."id" AS "id", "Course"."title" AS "title", "StudentCourse_1"."studentId" AS "studentCourses.studentId", "StudentCourse_1"."studentName" AS "studentCourses.studentName", "StudentCourse_1"."courseId" AS "studentCourses.courseId" FROM "Course" LEFT JOIN "StudentCourse" AS "StudentCourse_1" ON "Course"."id" = "StudentCourse_1"."courseId" WHERE "Course"."id" > ?1 ORDER BY "Course"."id" ASC LIMIT ?2`,
...
export namespace Student {
    ...
    export namespace GeneratedSource {
        export const CoursesOrderedDescending = {
            tree: {"studentCourses":{}},
            selectQueryRaw: `SELECT "Student"."id" AS "id", "Student"."name" AS "name", "Student"."favoriteColor" AS "favoriteColor", "StudentCourse_1"."studentId" AS "studentCourses.studentId", "StudentCourse_1"."studentName" AS "studentCourses.studentName", "StudentCourse_1"."courseId" AS "studentCourses.courseId" FROM "Student" LEFT JOIN "StudentCourse" AS "StudentCourse_1" ON "Student"."id" = "StudentCourse_1"."studentId" AND "Student"."name" = "StudentCourse_1"."studentName"`,
            getQueryRaw: `SELECT "Student"."id" AS "id", "Student"."name" AS "name", "Student"."favoriteColor" AS "favoriteColor", "StudentCourse_1"."studentId" AS "studentCourses.studentId", "StudentCourse_1"."studentName" AS "studentCourses.studentName", "StudentCourse_1"."courseId" AS "studentCourses.courseId" FROM "Student" LEFT JOIN "StudentCourse" AS "StudentCourse_1" ON "Student"."id" = "StudentCourse_1"."studentId" AND "Student"."name" = "StudentCourse_1"."studentName" WHERE ("Student"."id", "Student"."name") = (?1, ?2)`,
            listQueryRaw: `SELECT "Student"."id" AS "id", "Student"."name" AS "name", "Student"."favoriteColor" AS "favoriteColor", "StudentCourse_1"."studentId" AS "studentCourses.studentId", "StudentCourse_1"."studentName" AS "studentCourses.studentName", "StudentCourse_1"."courseId" AS "studentCourses.courseId" FROM "Student" LEFT JOIN "StudentCourse" AS "StudentCourse_1" ON "Student"."id" = "StudentCourse_1"."studentId" AND "Student"."name" = "StudentCourse_1"."studentName" WHERE ("Student"."id", "Student"."name") > (?1, ?2) ORDER BY "Student"."id" ASC, "Student"."name" ASC LIMIT ?3`,

            selectQuery(env: { db: Env["db"] }): D1PreparedStatement {
                return env.db.prepare(this.selectQueryRaw);
            },
            getQuery(env: { db: Env["db"] }, id: number, name: string): D1PreparedStatement {
                return env.db.prepare(this.getQueryRaw).bind(id, name);
            },
            listQuery(env: { db: Env["db"] }, lastId: number, lastName: string, limit: number): D1PreparedStatement {
                return env.db.prepare(this.listQueryRaw).bind(lastId, lastName, limit);
            },
        ...
        export const Default = {
            ...
            listQuery(env: { db: Env["db"] }, lastSeen_id: number, lastSeen_name: string, limit: number): D1PreparedStatement {
                return env.db.prepare(this.listQueryRaw).bind(lastSeen_id, lastSeen_name, limit);
            },
            async get(env: { db: Env["db"] }, id: number, name: string): Promise<HttpResult<Self | null>> {
                const stmt = this.getQuery(env, id, name);
                const res = await CloesceOrm.fromEnv(env).get<Self>(Meta, stmt, this.tree);
...
export namespace StudentCourse {
    ...
    export namespace GeneratedSource {
        export const Default = {
            tree: {},
            selectQueryRaw: `SELECT "StudentCourse"."studentId" AS "studentId", "StudentCourse"."studentName" AS "studentName", "StudentCourse"."courseId" AS "courseId" FROM "StudentCourse"`,
            getQueryRaw: `SELECT "StudentCourse"."studentId" AS "studentId", "StudentCourse"."studentName" AS "studentName", "StudentCourse"."courseId" AS "courseId" FROM "StudentCourse" WHERE ("StudentCourse"."studentId", "StudentCourse"."studentName", "StudentCourse"."courseId") = (?1, ?2, ?3)`,
            listQueryRaw: `SELECT "StudentCourse"."studentId" AS "studentId", "StudentCourse"."studentName" AS "studentName", "StudentCourse"."courseId" AS "courseId" FROM "StudentCourse" WHERE ("StudentCourse"."studentId", "StudentCourse"."studentName", "StudentCourse"."courseId") > (?1, ?2, ?3) ORDER BY "StudentCourse"."studentId" ASC, "StudentCourse"."studentName" ASC, "StudentCourse"."courseId" ASC LIMIT ?4`,

            selectQuery(env: { db: Env["db"] }): D1PreparedStatement {
                return env.db.prepare(this.selectQueryRaw);
            },
            getQuery(env: { db: Env["db"] }, studentId: number, studentName: string, courseId: number): D1PreparedStatement {
                return env.db.prepare(this.getQueryRaw).bind(studentId, studentName, courseId);
            },
            listQuery(env: { db: Env["db"] }, lastSeen_studentId: number, lastSeen_studentName: string, lastSeen_courseId: number, limit: number): D1PreparedStatement {
                return env.db.prepare(this.listQueryRaw).bind(lastSeen_studentId, lastSeen_studentName, lastSeen_courseId, limit);
            },
