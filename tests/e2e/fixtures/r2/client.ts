...
export class D1BackedModel {
  ...
  async uploadData(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/D1BackedModel/${id}/uploadData`
    );
    const payload: any = {};
    payload["data"] = data;
...
export class PureR2Model {
  ...
  async uploadData(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/PureR2Model/${id}/uploadData`
    );
    const payload: any = {};
    payload["data"] = data;
  ...
  async uploadOtherData(
    ...
    const baseUrl = new URL(
      `http://localhost:5646/api/PureR2Model/${id}/uploadOtherData`
    );
    const payload: any = {};
    payload["data"] = data;
