...
--- New Data Sources
CREATE VIEW IF NOT EXISTS "Foo.baz" AS SELECT "Foo"."id" AS "Foo.id" FROM "Foo";
CREATE VIEW IF NOT EXISTS "OneDs.default" AS SELECT "OneDs"."id" AS "OneDs.id" FROM "OneDs";
