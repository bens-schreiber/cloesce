...
CREATE VIEW "Student.withCoursesStudents" AS SELECT "Student"."id" AS "Student.id", "Course"."id" AS "Student.courses.id", "Student1"."id" AS "Student.courses.students.id" FROM "Student" LEFT JOIN "StudentsCourses" ON "Student"."id" = "StudentsCourses"."Student.id" LEFT JOIN "Course" ON "StudentsCourses"."Course.id" = "Course"."id" LEFT JOIN "StudentsCourses" ON "Course"."id" = "StudentsCourses"."Course.id" LEFT JOIN "Student" AS "Student1" ON "StudentsCourses"."Student1.id" = "Student1"."id";
CREATE VIEW "Student.withCoursesStudentsCourses" AS SELECT "Student"."id" AS "Student.id", "Course"."id" AS "Student.courses.id", "Student1"."id" AS "Student.courses.students.id", "Course1"."id" AS "Student.courses.students.courses.id" FROM "Student" LEFT JOIN "StudentsCourses" ON "Student"."id" = "StudentsCourses"."Student.id" LEFT JOIN "Course" ON "StudentsCourses"."Course.id" = "Course"."id" LEFT JOIN "StudentsCourses" ON "Course"."id" = "StudentsCourses"."Course.id" LEFT JOIN "Student" AS "Student1" ON "StudentsCourses"."Student1.id" = "Student1"."id" LEFT JOIN "StudentsCourses" ON "Student1"."id" = "StudentsCourses"."Student1.id" LEFT JOIN "Course" AS "Course1" ON "StudentsCourses"."Course1.id" = "Course1"."id";
